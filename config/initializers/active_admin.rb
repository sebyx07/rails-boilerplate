...
ActiveAdmin.setup do |config|
  ...
  config.namespace :admin do |admin|
    ...
    admin.head = ->(_) do
      ApplicationController.renderer.render(partial: 'active_admin/admin_head')
    end

    admin.footer = ->(_) do
      ApplicationController.renderer.render(partial: 'active_admin/admin_footer')
    end

    admin.root_to = 'users#index'

    admin.site_title = ->(_) do
      'Rails Boilerplate Admin'
    end
...
#   #
#   config.site_title = "Rails Boiler Plate"
#
